---
title: Skills
description: Add knowledge via code snippets or documentation
---

Skills provide agents with reusable knowledge patterns, code snippets, or procedures. They can be defined manually or crawled from documentation websites.
